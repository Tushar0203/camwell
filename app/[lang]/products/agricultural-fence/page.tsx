...
export default function AgriculturalFencePage() {
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-white mb-4 sm:mb-8 leading-tight tracking-tight">
                {isRTL ? 'سياج زراعي' : 'Agricultural Fence'}
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-blue-100/90 max-w-3xl mx-auto leading-relaxed mb-6 sm:mb-10 px-2">
                {isRTL
                  ? 'حلول سياج زراعي متينة وآمنة لحماية المحاصيل والممتلكات. نعمل على إطلاق هذه الصفحة قريباً.'
                  : "Durable and secure agricultural fencing solutions for crop and property protection. We're launching this page soon."}
              </p>
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-gray-600">
                {isRTL
                  ? 'نحن نعمل على إضافة معلومات وتفاصيل حول سياجنا الزراعي. تواصل معنا لمعرفة المزيد أو طلب استشارة.'
                  : "We're adding details about our agricultural fence solutions. Get in touch to learn more or request a consultation."}
              </p>
            </motion.div>
          </div>
        </div>
